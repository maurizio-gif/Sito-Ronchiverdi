...
// Orari, passi e disponibilità dell'agenda: stanno in un modulo a parte
// perché li usa anche la pagina che permette di spostare un appuntamento
// già preso (src/pages/appuntamento.astro).
import {
	caricaOccupati,
	isoDateLocal,
	regoleDi,
